module.exports = async (context) => {
  ...
  try {
    const replyText = `◈━┈┈┈┈┈┈┈┈┈┈┈┈┈┈━◈\n│❒ *Credits, Bitches*\n\nAll hail *Daudi_Musa*, the badass who built this bot from the ground up. Nobody else gets credit—fuck ‘em. This is my empire, and I run this shit solo.\n\nBow down to *Daudi_Musa* 🫡`;
